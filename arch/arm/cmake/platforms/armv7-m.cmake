############################################################################
# arch/arm/cmake/platforms/armv7-m.cmake
#
...
if (CONFIG_ARCH_TOOLCHAIN_CLANG)
  ...
  if (NOT EXISTS_FLAGS)
    set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS}${ARCHFLAGS}" CACHE STRING "" FORCE)
    set(CMAKE_C_FLAGS   "${CMAKE_C_FLAGS}${ARCHFLAGS}"   CACHE STRING "" FORCE)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}${ARCHFLAGS}" CACHE STRING "" FORCE)
  endif()
endif()
