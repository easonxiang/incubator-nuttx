...
get_directory_property(NUTTX_EXTRA_FLAGS DIRECTORY ${CMAKE_SOURCE_DIR} COMPILE_OPTIONS)

execute_process(
    COMMAND ${CMAKE_C_COMPILER} ${CMAKE_C_FLAGS} ${NUTTX_EXTRA_FLAGS} --print-libgcc-file-name
...
if (NOT EXISTS ${extra_library} AND CONFIG_ARCH_TOOLCHAIN_CLANG)
  ...
  execute_process(
      COMMAND ${CMAKE_C_COMPILER} ${CMAKE_C_FLAGS} ${NUTTX_EXTRA_FLAGS} --print-file-name ${COMPILER_RT_LIB}
      OUTPUT_STRIP_TRAILING_WHITESPACE
      OUTPUT_VARIABLE extra_library)
endif()
...
if (NOT CONFIG_LIBM)
  execute_process(
      COMMAND ${CMAKE_C_COMPILER} ${CMAKE_C_FLAGS} ${NUTTX_EXTRA_FLAGS} --print-file-name=libm.a
      OUTPUT_STRIP_TRAILING_WHITESPACE
      OUTPUT_VARIABLE extra_library)
  list(APPEND EXTRA_LIB ${extra_library})
endif()
...
if (CONFIG_LIBSUPCXX)
  execute_process(
      COMMAND ${CMAKE_C_COMPILER} ${CMAKE_C_FLAGS} ${NUTTX_EXTRA_FLAGS} --print-file-name=libsupc++.a
      OUTPUT_STRIP_TRAILING_WHITESPACE
      OUTPUT_VARIABLE extra_library)
  list(APPEND EXTRA_LIB ${extra_library})
endif()
...
if (CONFIG_ARCH_COVERAGE)
  execute_process(
      COMMAND ${CMAKE_C_COMPILER} ${CMAKE_C_FLAGS} ${NUTTX_EXTRA_FLAGS} --print-file-name=libgcov.a
      OUTPUT_STRIP_TRAILING_WHITESPACE
      OUTPUT_VARIABLE extra_library)
  list(APPEND EXTRA_LIB ${extra_library})
endif()
